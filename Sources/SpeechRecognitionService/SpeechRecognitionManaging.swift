...
/// speech recognition into a SwiftUI view.
///
...
///     
///     init() {
///         let config = DefaultSpeechConfig()
...
@preconcurrency
@MainActor
public protocol SpeechRecognitionManaging {
    ...
    var speechService: SpeechRecognitionService? { get }
